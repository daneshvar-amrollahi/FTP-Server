...
const int MKD_OK            =  258; //original: 257
const int DELE_OK           =  250;
const int LS_OK             =  226;
const int CWD_OK            =  251; //original: 250
const int RENAME_OK         =  252; //original: 250
const int HELP_OK           =  214; 
const int QUIT_OK           =  221;
const int RETR_OK           =  227; //original: 226
